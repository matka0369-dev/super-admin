...
const en: Dict = {
  ...
  'requests.imageHint': 'PNG, JPEG, or WebP — resized and compressed automatically',
  'requests.imageTooLarge': 'That image is too large to process',
  'requests.imageCompressing': 'Compressing image…',
  'requests.imageCompressFailed': 'Could not process that image — try a different one',
...
const hi: Dict = {
  ...
  'requests.imageHint': 'PNG, JPEG, या WebP — अपने आप छोटा और कंप्रेस किया जाएगा',
  'requests.imageTooLarge': 'यह इमेज प्रोसेस करने के लिए बहुत बड़ी है',
  'requests.imageCompressing': 'इमेज कंप्रेस हो रही है…',
  'requests.imageCompressFailed': 'यह इमेज प्रोसेस नहीं हो सकी — कोई और इमेज आज़माएं',
...
const mr: Dict = {
  ...
  'requests.imageHint': 'PNG, JPEG, किंवा WebP — आपोआप लहान आणि कंप्रेस केले जाईल',
  'requests.imageTooLarge': 'ही इमेज प्रोसेस करण्यासाठी खूप मोठी आहे',
  'requests.imageCompressing': 'इमेज कंप्रेस होत आहे…',
  'requests.imageCompressFailed': 'ही इमेज प्रोसेस करता आली नाही — दुसरी इमेज वापरून पहा',
...
const te: Dict = {
  ...
  'requests.imageHint': 'PNG, JPEG, లేదా WebP — స్వయంచాలకంగా చిన్నదిగా చేసి కంప్రెస్ చేయబడుతుంది',
  'requests.imageTooLarge': 'ఈ చిత్రం ప్రాసెస్ చేయడానికి చాలా పెద్దది',
  'requests.imageCompressing': 'చిత్రం కంప్రెస్ అవుతోంది…',
  'requests.imageCompressFailed': 'ఈ చిత్రాన్ని ప్రాసెస్ చేయలేకపోయాము — వేరే చిత్రాన్ని ప్రయత్నించండి',
...
const ta: Dict = {
  ...
  'requests.imageHint': 'PNG, JPEG, அல்லது WebP — தானாகவே சிறிதாக்கி சுருக்கப்படும்',
  'requests.imageTooLarge': 'இந்தப் படம் செயலாக்க மிகப் பெரியது',
  'requests.imageCompressing': 'படம் சுருக்கப்படுகிறது…',
  'requests.imageCompressFailed': 'இந்தப் படத்தைச் செயலாக்க முடியவில்லை — வேறு படத்தை முயற்சிக்கவும்',
...
const kn: Dict = {
  ...
  'requests.imageHint': 'PNG, JPEG, ಅಥವಾ WebP — ಸ್ವಯಂಚಾಲಿತವಾಗಿ ಚಿಕ್ಕದಾಗಿಸಿ ಕುಗ್ಗಿಸಲಾಗುತ್ತದೆ',
  'requests.imageTooLarge': 'ಈ ಚಿತ್ರ ಪ್ರಕ್ರಿಯೆಗೊಳಿಸಲು ತುಂಬಾ ದೊಡ್ಡದಾಗಿದೆ',
  'requests.imageCompressing': 'ಚಿತ್ರ ಕುಗ್ಗಿಸಲಾಗುತ್ತಿದೆ…',
  'requests.imageCompressFailed': 'ಈ ಚಿತ್ರವನ್ನು ಪ್ರಕ್ರಿಯೆಗೊಳಿಸಲು ಸಾಧ್ಯವಾಗಲಿಲ್ಲ — ಬೇರೆ ಚಿತ್ರವನ್ನು ಪ್ರಯತ್ನಿಸಿ',
